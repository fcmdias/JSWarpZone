// interpreter is a component that processes structured text data. Does so by turning it into seperate lexial tokens (lexing) and then interpreting sequences of said tokens (parsing)
