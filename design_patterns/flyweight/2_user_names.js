// flyweight is a space optimization technique that lets us use less memory by storing externally the the data associated with similar objects

class User
{
  constructor(fulllName)
  {
